...
--
-- Servidor: localhost
-- Tiempo de generación: 08-09-2025 a las 21:21:13
...
INSERT INTO `paquete` (`id_paquete`, `id_destino`, `nombre`, `descripcion`, `precio`, `duracion_dias`, `categoria`, `fecha_salida`, `fecha_regreso`, `promocion_activa`) VALUES
(1, 101, 'Aventura en Machu Picchu', 'Paquete con excursiones guiadas por Cusco y Machu Picchu', 1200.00, 7, 'Aventura', '2025-10-01', '2025-10-08', 1),
(2, 102, 'Playas de Cancún', 'Vacaciones todo incluido en hotel 5 estrellas frente al mar', 1500.00, 5, 'Playa', '2025-11-15', '2025-11-20', 1),
(3, 103, 'Safari en Kenia', 'Experiencia única con safaris en la reserva Masái Mara', 3500.00, 10, 'Safari', '2025-09-20', '2025-09-30', 0),
(4, 104, 'Turismo en París', 'Visita a la Torre Eiffel, Louvre y recorridos por la ciudad', 2000.00, 6, 'Cultural', '2025-12-05', '2025-12-11', 1),
(5, 105, 'Aventura en Patagonia', 'Trekking por glaciares y paisajes únicos del sur argentino', 1800.00, 8, 'Aventura', '2025-11-10', '2025-11-18', 0),
(6, 106, 'Crucero por el Caribe', 'Crucero de lujo con paradas en varias islas tropicales', 2500.00, 7, 'Crucero', '2025-10-20', '2025-10-27', 1),
(7, 107, 'Nueva York Exprés', 'Tour por Manhattan, Central Park y museos más famosos', 1300.00, 4, 'Urbano', '2025-09-25', '2025-09-29', 1),
(8, 108, 'Ruta Maya en México', 'Recorrido por Chichén Itzá, Tulum y cenotes de la región', 1600.00, 6, 'Cultural', '2025-12-01', '2025-12-07', 0),
(9, 109, 'Islas Griegas', 'Tour en barco por Santorini, Mykonos y Atenas', 2800.00, 9, 'Playa', '2025-07-15', '2025-07-24', 1),
(10, 110, 'Selva Amazónica', 'Exploración de la selva con guías locales y hospedaje ecológico', 1400.00, 5, 'Aventura', '2025-08-05', '2025-08-10', 0);
